...
class LeptonAnalyzer(Analyzer):
    ...
    # the following is temporary: all leptons are considered to be identified for now
        
    # the rhs is a lambda statement defining a 2-parameter function that returns True.
