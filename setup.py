...
setup(
    ...
    # package_data={
    #    'ee_ZH_Zmumu_Hbb.root': ['ee_ZH_Zmumu_Hbb.root'],
    #    'ee_Z_ddbar.root': ['ee_Z_ddbar.root'],
    # },
    ...
    scripts = ['scripts/heppy_hadd.py','scripts/heppy_check.py','scripts/heppy_batch.py','scripts/heppy_hadd.py']
)
